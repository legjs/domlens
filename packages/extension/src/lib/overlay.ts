...
export function showSelectedElementOverlay(
  ...
  if (!delBtn || !getShadowRoot().contains(delBtn)) {
    ...
    `
    delBtn.innerHTML = `<svg width="8" height="8" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>`
